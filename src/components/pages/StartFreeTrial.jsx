  ...
  return (
    <main className="relative bg-gradient-to-b from-white to-slate-50 text-slate-900 min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-indigo-200 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob"></div>
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-purple-200 rounded-full mix-blend-multiply filter blur-2xl opacity-50 animate-blob animation-delay-2000"></div>
        <div className="absolute top-40 left-1/3 w-[500px] h-[500px] bg-pink-200 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-blob animation-delay-4000"></div>
        <div className="absolute -bottom-8 right-1/4 w-[500px] h-[500px] bg-green-100 rounded-full mix-blend-multiply filter blur-2xl opacity-40 animate-blob"></div>
          ...
          <div className="bg-white px-4 py-8 shadow-xl ring-1 ring-slate-900/5 sm:rounded-2xl sm:px-10">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-2 text-sm text-slate-400">Start trial</span>
              </div>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="mt-2 relative">
                  ...
                  />
                  {email && (
                    <svg className="absolute right-3 top-2.5 h-5 w-5 text-green-500 animate-fadeIn" fill="currentColor" viewBox="0 0 20 20">
            ...
            {/* Compact benefits */}
            <div className="mt-6 py-3 bg-slate-50 rounded-lg">
            ...
            <div className="mt-6 flex items-center justify-center gap-4 text-sm">
              ...
              <a href="/talk-to-sales" className="text-indigo-600 hover:text-indigo-500">
                Talk to sales
              </a>
            </div>
          </div>
